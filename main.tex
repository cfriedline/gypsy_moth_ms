...
each SNP $i$ is given by $\hat{b_i} = \beta_i\gamma_i + \alpha_i$. Values represent the arithmetic 
...
\caption{Location, read, and mapping data for study populations. Means for number of reads and 
percent of reads mapped to the assembly are given along with standard deviation, in parentheses, and 
range, in brackets.}\\
\toprule
