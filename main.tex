...
The first two RDA axes explained $86.60\%$ of the total explainable variance (i.e. $86.60\%$ of $R^2 = 0.231$).
...
variation and geography had the largest pure effects (Figure 2B). Of these, the genetic PCs accounted for the
vast majority (i.e. $68.74\%$) of the total effect. Testing the statistical significance of the partial 
