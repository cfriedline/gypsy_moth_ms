...
were evalated for each SNP using \num{100000} MCMC inerations.  The covariance
structure among populuations was obtained from final variance-covariance matrix
