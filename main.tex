...
\subsection*{Patterns of phenotypic and genetic variation}
Phenotypic variation across samples varied by population, with
...
was driven largely by total development time (ANOVA: ), with mass being 
marginally differentiated among populations (ANOVA: ). No effect
was apparent for pupal development time. These results were consistent
with point estimates for 
