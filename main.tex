...
using standard variance partitioning methods \citep{Borcard:1992}.
...
variation (RDA: $F_{19,150} = 2.369, P = 1.0e-04, R^2 = 0.231$; Figure 2). The first two
RDA axes explained $86.60\%$ of the total explainable variance (i.e. $86.60\% of R^2 = 0.231$).
The first two RDA axes were dominated by mass and total development time, with the first axis reflecting
the correlation between mass and total development time and the second axis differentiating these two traits. The
remainder of the explainable variance was attributed to third axis, which was dominated by pupal duration time.

Partitioning the effects of each type of explanatory variable on phenotypic trait variation revealed that genetic
variation and geography had the largest pure effects ( ). Climate variation was confounded with either of these
two variable types. 
